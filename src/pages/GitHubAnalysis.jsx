...
const TEST_PROFILES = [
  ...
  { id: 'full', name: 'Full Audit', desc: 'All 14 modules', modules: ['failureMode', 'security', 'hallucination', 'oracle', 'complexity', 'mutation', 'property', 'differential', 'typescript', 'accessibility', 'dependency', 'deadCode', 'customRules', 'aiReview'], icon: Search, color: 'text-blue-600 bg-blue-50 border-blue-200' },
]
