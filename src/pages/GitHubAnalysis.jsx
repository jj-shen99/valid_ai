...
const TEST_PROFILES = [
  ...
  { id: 'full', name: 'Full Audit', desc: 'All 13 modules', modules: ['failureMode', 'security', 'hallucination', 'oracle', 'complexity', 'mutation', 'property', 'differential', 'typescript', 'accessibility', 'dependency', 'customRules', 'aiReview'], icon: Search, color: 'text-blue-600 bg-blue-50 border-blue-200' },
]
